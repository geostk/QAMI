...
figure,plot(con,'-*'),hold on;
for i = 1:num
    text(i,con(i),num2str(i));
end
figure,plot(def,'-*'),hold on;
for i = 1:num
    text(i,def(i),num2str(i));
end
figure,plot(ent,'-*'),hold on;
for i = 1:num
    text(i,ent(i),num2str(i));
end
figure,plot(sn,'-*'),hold on;
for i = 1:num
    text(i,sn(i),num2str(i));
end
