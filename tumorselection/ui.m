...
% [cc valleys] = lookForExtreme(arrEntropy);
% [peaks cc] = lookForExtreme(arr);
% load slice5;
% goodQuality = find(slice5>8);
% num1 = 0;
% num2 = 0;
% for i = 1:size(goodQuality,1)
%     if(sum(valleys == goodQuality(i)) == 1)
%         num1 = num1 + 1;
%     end
% end
% Q1 = num1/size(goodQuality,1);
%     arr;
